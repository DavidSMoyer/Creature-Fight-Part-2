...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if (turnNumber == 0)
        {
            playerOneName = JOptionPane.showInputDialog(null,"Insert player one name.","Pokemon",JOptionPane.QUESTION_MESSAGE);
            playerTwoName = JOptionPane.showInputDialog(null,"Insert player two name.","Pokemon",JOptionPane.QUESTION_MESSAGE);
     ...
     * 
     * @param turn The current turn to be set.
