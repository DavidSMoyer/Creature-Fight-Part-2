...
public class Pikachu extends Creature
{
     ...
     * attack
     * 
     * Runs a command to attack the enemy.
     * 
     * @param idx The id of the attack to use.
    ...
    public void attack(int idx)
    {
        ...
        String enemyType = playerWorld.getPlayerOne().getType();
        if (idx == 0)
        {
            playerWorld.getPlayerOne().getHealthBar().add(-30);
        }
        else
        {
            playerWorld.getPlayerOne().getHealthBar().add(-65);
        }
